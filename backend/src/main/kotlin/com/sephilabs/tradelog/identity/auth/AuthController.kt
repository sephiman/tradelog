...
class AuthController(
    ...
    /** What the SPA may offer before anyone is signed in. Both flags follow the optional SMTP group:
     *  without it there is no reset link to show, and an email change applies without verification. */
    @GetMapping("/features")
