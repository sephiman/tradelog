...
data class PositionDto(
    ...
    /** Null on a grid-bot run, which has no single size or leg price; the UI renders those as "—". */
    @JsonFormat(shape = JsonFormat.Shape.STRING) val qty: BigDecimal?,
    ...
    @JsonFormat(shape = JsonFormat.Shape.STRING) val volume: BigDecimal?,
    @JsonFormat(shape = JsonFormat.Shape.STRING) val leverage: BigDecimal?,
    @JsonFormat(shape = JsonFormat.Shape.STRING) val investment: BigDecimal?,
    val note: String?,
...
data class ClosedPositionSummaryDto(
    ...
    @JsonFormat(shape = JsonFormat.Shape.STRING) val fees: BigDecimal,
    @JsonFormat(shape = JsonFormat.Shape.STRING) val funding: BigDecimal,
    /** Volume as recorded, when the legs cannot produce it; null = derive from qty and the legs. */
    @JsonFormat(shape = JsonFormat.Shape.STRING) val volume: BigDecimal?,
    val tags: List<PositionTagView>,
)
