 ...
 */
export function SignedBar(props: RectangleProps & { payload?: { pnl?: number; roi?: number | null } }) {
  const val = props.payload?.roi ?? props.payload?.pnl ?? 0;
  return <Rectangle {...props} fill={barColor(Number(val))} />;
}
